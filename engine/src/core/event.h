...
namespace caliope {
	typedef enum event_system_code {
		...
		EVENT_CODE_ON_ENTITY_PRESSED = 0X0A,
		EVENT_CODE_ON_ENTITY_RELEASED = 0X0B,

		EVENT_CODE_ON_UI_BUTTON_PRESSED = 0X1A,
		EVENT_CODE_ON_UI_BUTTON_RELEASED = 0X1B,
		EVENT_CODE_ON_UI_BUTTON_HOVER = 0X1C,
		EVENT_CODE_ON_UI_BUTTON_UNHOVER = 0X1D,
		EVENT_CODE_ON_UI_BUTTON_CLICKED = 0X1E,
